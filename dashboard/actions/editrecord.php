...
if(!empty($_POST[])){
  ...
  $selectrecord = $conn->query("SELECT * FROM tblpersonal_information");
  $rowmasterrecord = $selectrecord->fetch(PDO::FETCH_ASSOC);
        ...
        <div class=""> <!--page-wrapper-->
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <button class="btn btn-default color-yellow">Back</button> </div>
